...
/const/ declares constants with a specific type in the same way as one
...
#+begin_example
  ...
  cout << "Size fo String is " << myString.size() << endl;
  cout << "Is string empty? " << myString.empty() << endl;
  cout << myString.append(" I'm ChongChong.") << endl;
#+end_example

Assign string

#+begin_example
  string myName = "ChongChong He";
  cout << "first name is " << myName.assign(myName, 0, 10);
#+end_example

Search string index

#+begin_example
  int lastNameIndex = myName.find("He", 0); // search starts from 0
#+end_example

Inseart and delete strings

#+begin_example
  myName.insert (10, "Jordan ");
  myName.erase(10, 7);
  myName.replace(11, 2, "Hehe");
#+end_example
